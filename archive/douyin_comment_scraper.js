...
const CONFIG_PATH = path.join(__dirname, '..', '.claude', 'skills', 'douyin-comment-scraper', 'config.json');
let COOKIES = [];
if (fs.existsSync(CONFIG_PATH)) {
  try { COOKIES = JSON.parse(fs.readFileSync(CONFIG_PATH, 'utf-8')).cookies || []; } catch (_) {}
}
